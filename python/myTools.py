...
def createNN(data_size, X, Y, valX, valY, epochs, n_batches, batch_size, learning_rate, w_decay):
	...
	net['conv5'] = lasagne.layers.batch_norm(lasagne.layers.Conv2DLayer(net['pool4'], num_filters=35, filter_size=5))
	net['deconv5']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['conv5'], num_filters=35, filter_size=5))
	net['unpool4']= lasagne.layers.InverseLayer(net['deconv5'], net['pool4'])
	net['deconv4']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['unpool4'], num_filters=35, filter_size=5))
