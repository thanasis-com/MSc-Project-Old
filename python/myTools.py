...
def createNN(data_size, X, Y, valX, valY, epochs, n_batches, batch_size, learning_rate, w_decay):
	...
	net['deconv4']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['conv4'], num_filters=10, filter_size=5))
	...
	net['deconv1']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['unpool1'], num_filters=10, filter_size=5))
