...
def createNN(data_size, X, Y, valX, valY, epochs, n_batches, batch_size, learning_rate, w_decay):
	...
	net['unpool3']= lasagne.layers.Upscale2DLayer(net['unpool3'],net['deconv4'], pool_size=2)
	net['deconv3']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['unpool3'], num_filters=64, filter_size=5))
	net['unpool2']= lasagne.layers.Upscale2DLayer(net['unpool2'],net['deconv3'], pool_size=2)
	net['deconv2']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['unpool2'], num_filters=32, filter_size=5))
	net['unpool1']= lasagne.layers.Upscale2DLayer(net['unpool1'],net['deconv2'], pool_size=2)
