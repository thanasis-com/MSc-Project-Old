...
def myCrossEntropy(predictions, targets):
	...
	return -1*targets*T.log(predictions)*r+(-1)*(1-targets)*T.log(1-predictions)*(1-r)
...
def myTestCrossEntropy(predictions, targets):
	...
	return numpy.average(-1*targets*numpy.log(predictions)*r+(-1)*(1-targets)*numpy.log(1-predictions)*(1-r))
