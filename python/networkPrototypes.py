...
#Input layer:
	...
	#the rest of the network structure
	net['conv1'] = lasagne.layers.batch_norm(lasagne.layers.Conv2DLayer(net['data'], num_filters=20, filter_size=5))
	net['pool1'] = lasagne.layers.Pool2DLayer(net['conv1'], pool_size=2)
	...
	net['pool4'] = lasagne.layers.Pool2DLayer(net['conv4'], pool_size=2)
	net['conv5'] = lasagne.layers.batch_norm(lasagne.layers.Conv2DLayer(net['pool4'], num_filters=20, filter_size=5))
	net['deconv5']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['conv5'], num_filters=20, filter_size=5))
	net['unpool4']= lasagne.layers.InverseLayer(net['deconv5'], net['pool4'])
	net['deconv4']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['unpool4'], num_filters=20, filter_size=5))
	net['unpool3']= lasagne.layers.InverseLayer(net['deconv4'], net['pool3'])
	...
	net['unpool1']= lasagne.layers.InverseLayer(net['deconv2'], net['pool1'])
	net['deconv1']= lasagne.layers.batch_norm(myClasses.Deconv2DLayer(net['unpool1'], num_filters=20, filter_size=5))
