...
'''
#load the pretrained network
myNet4=myTools.createPretrainedNN2(data_size, modelFile='myModelNew02.npz', filters=32)
#make predictions for the image
res4=myNet4(image)
#crop the center of the mask
...
#load the pretrained network
myNet5=myTools.createPretrainedNN2(data_size, modelFile='myModelNew03.npz', filters=32)
#make predictions for the image
res5=myNet5(image)
#crop the center of the mask
...
#load the pretrained network
myNet6=myTools.createPretrainedNN2(data_size, modelFile='myModel03plus90.npz', filters=32)
#make predictions for the image
res6=myNet6(image)
#crop the center of the mask
...
#load the pretrained network
myNet7=myTools.createPretrainedNN2(data_size, modelFile='myModel04plus90.npz', filters=32)
#make predictions for the image
res7=myNet7(image)
#crop the center of the mask
